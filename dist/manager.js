...
var defaultShouldAvoidLoad = function () {
...
var load = exports.load = function (options, loadCn) {
  var _options$shouldAvoidL = options.shouldAvoidLoad,
      shouldAvoidLoad = _options$shouldAvoidL === undefined ? defaultShouldAvoidLoad : _options$shouldAvoidL;

  if (shouldAvoidLoad()) {
    // Do nothing if run from server-side
    return;
  }
  var _options$appendTo = options.appendTo,
      appendTo = _options$appendTo === undefined ? document.head : _options$appendTo;
